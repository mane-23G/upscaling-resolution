...
def frame_upscale(path: str, fin_path: str):
    ...
    for frame in frames.iterdir():
        ...
        img2 = np.empty((row*2, col*2, 3), dtype=np.uint8)
        ...
        for r in range(row):
            for c in range(col):
                ...
                # #first top box
                print("first top box")
                print(f"{img1[r,c,0]} = {img1[r,c,0]}")
                print(f"{img1[r,c,1]} = {img1[r,c,0]}")
                print(f"{img1[r,c,2]} = {img1[r,c,0]}")
                ...
                print(f"{img1[r,c,0]} + {img1[r,c1,0]} /2 = {(img1[r,c,0] + img1[r,c1,0]) / 2}")
                print(f"{img1[r,c,1]} + {img1[r,c1,1]} /2 = {(img1[r,c,1] + img1[r,c1,1]) / 2}")
                print(f"{img1[r,c,2]} + {img1[r,c1,2]} /2 = {(img1[r,c,2] + img1[r,c1,2]) / 2}")
                ...
                print(f"{img1[r,c,0]} + {img1[r1,c,0]} /2 = {(img1[r,c,0] + img1[r1,c,0]) / 2}") 
                print(f"{img1[r,c,1]} + {img1[r1,c,1]} /2 = {(img1[r,c,1] + img1[r1,c,1]) / 2}")
                print(f"{img1[r,c,2]} + {img1[r1,c,2]} /2 = {(img1[r,c,2] + img1[r1,c,2]) / 2}")
                ...
                print(f"{img1[r,c,0]} + {img1[r1,c1,0]} /2 = {(img1[r1,c1,0] + img2[2*r,2*c+1,0]) / 2}")
                print(f"{img1[r,c,1]} + {img1[r1,c1,1]} /2 = {(img1[r1,c1,1] + img2[2*r,2*c+1,1]) / 2}")
                print(f"{img1[r,c,2]} + {img1[r1,c1,2]} /2 = {(img1[r1,c1,2] + img2[2*r,2*c+1,2]) / 2}")
                img2[2*r+1,2*c+1,0] = (img1[r1,c1,0] + img2[2*r,2*c+1,0]) / 2
                img2[2*r+1,2*c+1,1] = (img1[r1,c1,1] + img2[2*r,2*c+1,1]) / 2
                img2[2*r+1,2*c+1,2] = (img1[r1,c1,2] + img2[2*r,2*c+1,2]) / 2
